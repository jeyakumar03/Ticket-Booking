public class Queries{
	...
	public static final String getMovieQuery = "SELECT id FROM movie WHERE id = ?";
           ...
           public static final String theatreQuery = "SELECT capacity, booked_seats FROM theatre WHERE id = ? AND movie = ?";
           ...
           public static final String updateBookedSeatsQuery = "UPDATE theatre SET booked_seats = ? WHERE id = ? AND session_id = ?";
